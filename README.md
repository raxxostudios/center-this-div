...
| `/api/stats` | GET | Global counters + recent 50 attempts |
| `/api/teapot` | GET | HTTP 418 |

Rate limited: 1 submission per 2 seconds per IP. Anti-cheat: deviations below 0.3px are rejected with 418.
